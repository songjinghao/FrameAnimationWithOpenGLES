package com.paul.song.frameanimation.gles20;
 ...
 * Copyright (C)
 * <p>
 * FileName: FrameForDraw  Opengl es 2.0 版本
 * <p>
 * Author: Paul Song
 * <p>
 * Date: 2020/5/5 23:46
...
//    private ByteBuffer emptyBuffer;
    ...
    private SparseArray<ETC1Util.ETC1Texture> mTextureCache = new SparseArray<>(); // TODO: 替换成线程安全map
    ...
    private void initShader(Resources resources) {
        ...
        msTextureAlphaHandle = GLES20.glGetUniformLocation(mProgram, "sTextureAlpha");
    }
...
//        GLES20.glUniformMatrix4fv(muMVPMatrixHandle, 1, false, MatrixState.getFinalMatrix(), 0);
        ...
        //将顶点纹理坐标数据传入渲染管线
        GLES20.glVertexAttribPointer(maTexCoorHandle, 2, GLES20.GL_FLOAT, false, 0, mTexCoorBuffer);

        ETC1Util.ETC1Texture t, tAlpha;
...
//            Log.d(TAG, "drawSelf");
            ...
            GLES20.glUniform1i(msTextureAlphaHandle, 1);
        } else {
//            isPlay = false;
            ...
            if (!mView.isOneShot()) {//循环播放
                ...
                GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
                GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, textures[0]);
                ETC1Util.loadTexture(GLES20.GL_TEXTURE_2D, 0, 0, GLES20.GL_RGB, GLES20.GL_UNSIGNED_SHORT_5_6_5, new ETC1Util.ETC1Texture(viewWidth, viewHeight, emptyBuffer));
                GLES20.glUniform1i(msTextureHandle, 0);
