...
uniform vec4 u_Color; // 曲线颜色
uniform float u_Amp; // 振幅
uniform vec4 u_BzData; // 起始点p0、结束点p3坐标位置
uniform vec4 u_BzDataCtrl; // 控制点p1、p2坐标位置


attribute float a_TData; // Bezier t variable

varying vec4 v_Color; // 传递给片元着色器的 wave color
varying vec4 v_UV;
